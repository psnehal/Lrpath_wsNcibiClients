...
class LRPathArgsUtil
{
	...
	public static List<NameValuePair> buildNameValueArgsFromLRPathData(LRPathArguments data)
	{
		...
		args.add(NameValuePairUtil.buildNameValuePairFromCollection("readcount", toDoubleList(data.getReadcount())));
		...
		args.add(NameValuePairUtil.buildNameValuePairFromNameValue("rnaseq", data.getRnaseq()));
		args.add(NameValuePairUtil.buildNameValuePairFromNameValue("avgread", data.getAvgread()));
		args.add(NameValuePairUtil.buildNameValuePairFromNameValue("customfile", data.getCustomfile()));
		args.add(NameValuePairUtil.buildNameValuePairFromNameValue("outname", data.getOutname()));
		System.out.println("Added arguments with customFile" + data.getCustomfile());
		return args;
